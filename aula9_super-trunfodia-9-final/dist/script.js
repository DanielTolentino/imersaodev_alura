...
function exibeCartaJogador() {
    ...
    var opcoesTexto = ""
    var nomeAtributo =  '<p class="carta-atributos">Atributos</p>'
    ...
    divCartaJogador.innerHTML = moldura + nome + nomeAtributo + html + opcoesTexto + '</div>'
}
...
function jogar() {
    ...
    if(cartas.length == 0){
      ...
      htmlResultado = '<p class="resultado-final">A Máquina Ganhou!</p>'
    } else {
      htmlResultado = '<p class="resultado-final">Empatou!</p>'
    }      
 } else{
...
function exibeCartaMaquina() {
    ...
    divCartaMaquina.innerHTML = moldura + nome + nomeAtributo + html + opcoesTexto + '</div>'
}
